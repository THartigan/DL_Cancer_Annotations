...
class SCNN_TPL3(nn.Module):
    ...
    def __init__(self, apriori_relevance, leak_rate, dropout_rate, input_channels):
        ...
        self.core2_2 = nn.Conv1d(in_channels=16, out_channels=16, kernel_size=9, stride=4)
        ...
        self.core3_2 = nn.Conv1d(in_channels=32, out_channels=32, kernel_size=9, stride=4)
        ...
        self.core5 = nn.Linear(1600, 32) #25152
